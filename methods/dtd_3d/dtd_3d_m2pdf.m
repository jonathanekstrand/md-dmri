function dtd_3d_m2pdf(dps_fn, pdf_path, opt)
% function dtd_3d_m2pdf(dps_fn, pdf_path, opt)
...
%                             c.ms = 100/min(sz(1:2))*ms_max*sqrt(w/s0max);
                            ...
                            for nc = 1:n
                                col = c.bright(nc)*[c.r(nc) c.g(nc) c.b(nc)];
                                h1 = scatter3(axh1,c.x(nc),c.y(nc),c.z(nc));
                            ...
                            while count < length(Cont)
                                ...
                                h = plot3(axh1, xtemp,ytemp,zmin*ones(size(xtemp)),'k-','LineWidth',lw_contour);
                                hcontour = [hcontour; h];
                                count = count + numxy + 1;
                            end
                            ...
                            while count < length(Cont)
                                ...
                                xtemp = Cont(1,count+(1:numxy));
                                ytemp = Cont(2,count+(1:numxy));
                                h = plot3(axh1, xtemp,ymax*ones(size(xtemp)),ytemp,'k-','LineWidth',lw_contour);
                                hcontour = [hcontour; h];
                                count = count + numxy + 1;
                            end
                            ...
                            while count < length(Cont)
                                ...
                                xtemp = Cont(1,count+(1:numxy));
                                ytemp = Cont(2,count+(1:numxy));
                                h = plot3(axh1, xmin*ones(size(xtemp)),xtemp,ytemp,'k-','LineWidth',lw_contour);
                                hcontour = [hcontour; h];
                                count = count + numxy + 1;
                            end
...
% eval(['print ' pdf_path '/dtd_3d_2Dmap -loose -dpdf'])
eval(['print ' pdf_path '/dtd_3d_2Dmap -loose -dpng -r300'])
pause(1.5)
...
eval(['print ' pdf_path '/dtd_3d_global -loose -dpdf'])
