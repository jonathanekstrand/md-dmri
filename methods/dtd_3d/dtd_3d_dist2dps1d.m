function dps1d = dtd_3d_dist2dps1d(dtd_3d)
% dps1d = dtd_3d_dist2dps1d(dtd_3d)
%
...
%
% Input arguments
% dtd_3d: diffusion tensor distribution
%
% Output
...
if n > 0
    ...
    dtd_3d_nx21 = tm_1x6_to_1x21(dtd_3d_nx6);
    dps1d.ct1x21 = (dtd_3d_nx21'*w)'/s0 - dt1x21;
